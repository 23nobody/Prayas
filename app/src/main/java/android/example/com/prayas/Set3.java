...
class Set3 extends Fragment {
    public static ArrayList<String> selectedStudents3 = new ArrayList<>();
    public Set3() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLocalReference=mStudentDatabaseReference.getRef().child("SET-3");
        List<Student> set3Students = new ArrayList<>();
        mStudentAdapter = new StudentAdapter(getContext(),set3Students);
